        ...
        <AuthenticatedLayout back userLogin={auth.user}>
            <div className="p-6 rounded-xl bg-gray-50 space-y-6">
                ...
                <form onSubmit={handleOnSubmit} className="space-y-6">
                    <div>
                        <Label htmlFor="name" text="Nama Referensi" />
                        <InputText
                            autoFocus
                            name="name"
                    ...
                    <div>
                        <Label htmlFor="slug" text="Slug Referensi" />
                        <InputText
                            name="slug"
                            placeholder="Slug Referensi..."
                            value={data.slug}
                    ...
                    <div>
                        <Label htmlFor="slug" text="Deskripsi Referensi" />
                        <InputTextArea
                            name="description"
                    ...
                    <div>
                        <Label htmlFor="file" text="File Referensi" />
                        <InputFile
                            name="file"
