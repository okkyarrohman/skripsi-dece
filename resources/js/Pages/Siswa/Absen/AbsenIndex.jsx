                ...
                <TableContainer>
                    ...
                    <TableBody>
                        {absens.map((absen, index) => {
                            const userPresent = absen.presents.find(
                                (user) => user.user_id == auth.user.id
                            );

                            return (
                                <TableRow key={index}>
                                    <TableData children={index + 1} />
                                    <TableData children={absen.name} />
                                    <TableData
                                        children={
                                            <Status
                                                activeStatus="Hadir"
